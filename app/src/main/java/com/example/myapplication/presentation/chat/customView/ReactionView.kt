package com.example.myapplication.presentation.chat.customView
...
class ReactionView @JvmOverloads constructor(
    ...
    init {
        ...
        try {
            emojiCode = typedArray.getString(R.styleable.ReactionView_emojiCode)
                ?: ""
            reactionsCount = typedArray.getInteger(R.styleable.ReactionView_reactionsCount, 0)
        } finally {
            typedArray.recycle()
        }
    }
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        val smileViewText = emojiCode + reactionsCount
