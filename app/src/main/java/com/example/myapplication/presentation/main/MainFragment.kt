...
import com.example.myapplication.presentation.channels.ChannelsFragment
...
class MainFragment : Fragment(R.layout.fragment_main) {
    ...
    private fun setTabFragment(fragment: Fragment, fragmentTag: String) {
        ...
        if (fragmentInStack != null) {
            Log.d(TAG, "setTabFragment() found fragment $fragmentInStack")
            childFragmentManager.beginTransaction()
                .replace(R.id.fragments_Container, fragmentInStack, fragmentTag)
                .commit()
        } else {
            Log.d(TAG, "setTabFragment() adding to backStack: fragment = $fragment")
            childFragmentManager.beginTransaction()
    ...
    fun toggleBottomNavigationViewVisibility() {
        binding.bottomNavigationView.isVisible = !binding.bottomNavigationView.isVisible
    }
